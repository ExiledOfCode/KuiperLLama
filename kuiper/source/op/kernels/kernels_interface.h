...
typedef void (*MatmulKernelAwqInt4)(const tensor::Tensor& input, const tensor::Tensor& weight,
                                    const tensor::Tensor& output, int32_t group_size,
...
typedef void (*MHAKernel)(int32_t pos, int32_t head_num, int32_t layer_index, int32_t seq_len,
                          ...
                          const tensor::Tensor& value_cache_tensor, const void* key_page_table,
                          const void* value_page_table, int32_t page_size, bool paged_kv_cache,
